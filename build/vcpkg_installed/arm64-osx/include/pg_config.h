...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/Users/taeuk/Server/build/vcpkg_installed/arm64-osx' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc -DNDEBUG -fPIC -O3' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/Users/taeuk/Server/build/vcpkg_installed/arm64-osx/lib' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/opt/homebrew/bin/pkg-config' 'PKG_CONFIG_PATH=/Users/taeuk/vcpkg/packages/libpq_arm64-osx/lib/pkgconfig:/Users/taeuk/vcpkg/packages/libpq_arm64-osx/share/pkgconfig:/Users/taeuk/Server/build/vcpkg_installed/arm64-osx/lib/pkgconfig:/Users/taeuk/Server/build/vcpkg_installed/arm64-osx/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.9 on aarch64-apple-darwin25.3.0, compiled by Apple clang version 17.0.0 (clang-1700.6.4.2), 64-bit"
